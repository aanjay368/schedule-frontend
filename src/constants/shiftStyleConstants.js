export const shiftStyles = {
  purple: {
    ...
    button: "bg-purple-800/30 hover:bg-purple-800/50",
  },
  pink: {
    ...
    button: "bg-pink-800/30 hover:bg-pink-800/50",
  },
  indigo: {
    ...
    button: "bg-indigo-800/30 hover:bg-indigo-800/50",
  },
  red: {
    ...
    button: "bg-red-800/30 hover:bg-red-800/50",
  },
};