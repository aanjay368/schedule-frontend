      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-12 max-w-4xl">
          <div className="grid gap-6">
            {/* 404 Error Card */}
            <div className="group relative overflow-hidden rounded-2xl border dark:border-red-500/20 border-red-200 bg-gradient-to-br from-red-50 to-red-50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:from-red-500/50 dark:to-red-900/20">
              {/* Header */}
              ...
              <div className="px-6 pb-6">
                <div className="space-y-4">
                  <div className="rounded-xl bg-white/50 p-6 text-center">
                    <div className="mb-4">
                      <Search className="text-gray-700 dark:text-gray-100 h-20 my-12 text-center w-full"/>
                    </div>
            ...
            {/* Quick Links Card */}
            <div className="group relative overflow-hidden rounded-2xl border dark:border-purple-600 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:from-pink-500 dark:to-purple-500">
              {/* Header */}
              <div className="relative p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
              ...
              <div className="px-6 pb-6">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  >
                    <Calendar className="text-gray-700 dark:text-gray-100 h-12 my-6 text-center w-full"/>
                    <p className="font-medium text-gray-900 dark:text-gray-100">Jadwal</p>
                    <p className="text-sm text-gray-600 dark:text-gray-200">Kelola jadwal kerja</p>
                  </Link>
                  ...
                  <Link
                    ...
                    className="group/item rounded-xl bg-white/50 p-4 text-center transition-all duration-200 hover:bg-white hover:shadow-sm"
                  >
                    <User className="text-gray-700 dark:text-gray-100 h-12 my-6 text-center w-full"/>                    
                    <p className="font-medium text-gray-900 dark:text-gray-100">Profile</p>
                    <p className="text-sm text-gray-600 dark:text-gray-100">Profile Pribadi</p>
                  </Link>
                  {/* <Link
                    to="/emp/setting"
                    className="group/item rounded-xl bg-white/50 p-4 text-center transition-all duration-200 hover:bg-white hover:shadow-sm"
